...
public class RDEHttpServer implements Closeable {
  ...
  public synchronized void start() throws IOException {
    ...
    // TODO create the routes for `/NAMESPACE/encode` and `/NAMESPACE/decode` by 
    // iterating over the NAMESPACES list in `AbstractRemoteDataEncoderCodec.java`
    
    // Hint: Here is how you would create the route if you were hardcoding the routes.
    // You may need to delete this code or modify it within your loop
